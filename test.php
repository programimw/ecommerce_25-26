...
try {
    ...
    $mail->addAddress('programimw@gmail.com', 'Web Programming');     //Add a recipient
    $mail->addAddress('eduart.torba@gmail.com');               //Name is optional
//    $mail->addReplyTo('info@example.com', 'Information');
    $mail->addCC('eduart.torba@fti.edu.al');
