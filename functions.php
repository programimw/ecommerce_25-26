...
function sendEmail($data)
{
    ...
    try {
        ...
        $mail->Username = 'noreplyprogramimweb@gmail.com';                     //SMTP username
        $mail->Password = 'hbbn dbgn ylom kood';                               //SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

        //Recipients
        $mail->setFrom('noreplyprogramimweb@gmail.com', 'No Reply');
//        $mail->addAddress(''test@example.com'', 'User Name');     //Add a recipient
